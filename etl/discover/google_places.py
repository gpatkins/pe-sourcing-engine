...
def search_places_new(text_query: str, page_token: Optional[str] = None, region_code: Optional[str] = None) -> Dict[str, Any]:
    ...
    headers = {
        ...
        # Minimal reliable FieldMask for Text Search
        "X-Goog-FieldMask": "places.id,places.displayName,places.formattedAddress,places.websiteUri,places.primaryPhone,places.rating,places.userRatingCount,places.location"
    }
...
def upsert_company(place: Dict[str, Any], user_id: int) -> None:
    ...
    phone = place.get("primaryPhone")  # Updated field name
