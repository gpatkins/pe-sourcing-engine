...
def main():
    ...
    # Also create config/secrets.env for the app to load API keys from
    print("Creating config/secrets.env...")
    secrets_env_content = f"""# PE Sourcing Engine - API Keys Configuration
# Updated by installer on deployment
...
"""
    ...
    print("✅ config/secrets.env created.")
